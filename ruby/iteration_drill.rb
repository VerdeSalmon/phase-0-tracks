...
extinct_animals_finder = ["Andean Cat","Dodo","Saiga Antelope"]

	extinct_animals.each_key do |extinct_animals|
		extinct_animals_finder.each do |animal|
...
sort_extinct_animals = extinct_animals.sort_by {|animal, extinction_year| extinction_year}
